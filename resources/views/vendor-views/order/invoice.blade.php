...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" href="{{ asset('assets/back-end/css/invoice.css') }}">
</head>
            ...
            <tr>
                <th class="content-position-y bg-light py-4">
                    <div class="d-flex justify-content-center gap-2">
                        <div class="mb-2">
                            <img height="10" src="{{ asset('assets/front-end/img/icons/telephone.png') }}" alt="">
                            {{ucwords('phone')}}
                            : {{ $companyPhone }}
                        </div>
                        <div class="mb-2">
                            <img height="10" src="{{ asset('assets/front-end/img/icons/email.png') }}" alt="">
                            {{ucwords('email')}}
                            : {{$companyEmail}}
                        </div>
                    </div>
                    <div class="mb-2">
                        <img height="10" src="{{ asset('assets/front-end/img/icons/web.png') }}" alt="">
                        {{url('/')}}
                    </div>
                    <div>
