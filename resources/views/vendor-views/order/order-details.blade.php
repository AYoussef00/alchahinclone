                        ...
                        @if($physicalProduct)
                            <ul class="list-unstyled">
                                ...
                                @if ($shippingMethod=='sellerwise_shipping')
                                    ...
                                    <li id="choose_delivery_man" class="mt-3 choose_delivery_man">
                                        ...
                                        @else
                                            <div class="p-2 bg-light rounded mt-4">
                                                <div class="media m-1 gap-3">
                                                    <img class="avatar rounded-circle" src="{{asset('assets/back-end/img/delivery-man.png')}}" alt="{{translate('image')}}">
                                                    <div class="media-body">
                                ...
                                <li class=" mt-3" id="by_third_party_delivery_service_info">
                                    <div class="p-2 bg-light rounded mt-4">
                                        <div class="media m-1 gap-3">
                                            <img class="avatar rounded-circle" src="{{asset('assets/back-end/img/third-party-delivery.png')}}"
                                                 alt="{{translate('image')}}">
                                            <div class="media-body">
...
@push('script')
    ...
    <script src="{{asset('assets/back-end/js/vendor/order.js')}}"></script>
@endpush
