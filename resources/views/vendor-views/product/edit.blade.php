...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{route('vendor.products.update',$product->id)}}" method="post"
                                    ...
                                    <div class="custom_upload_input">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img alt=""
                                                     src="{{ asset('assets/back-end/img/icons/product-upload-icon.svg') }}"
                                                     class="w-75">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <div
                                                                ...
                                                                <img alt="" src="{{ asset('assets/back-end/img/icons/product-upload-icon.svg') }}"
                                                                     class="w-75">
                                                                <h3 class="text-muted">{{ translate('Upload_Image') }}</h3>
                                                            </div>
                                                        </div>
            ...
            <div class="d-flex justify-content-end mt-3">
                <button type="submit" class="btn btn--primary px-5 product-add-requirements-check">
    ...
    <span id="image-path-of-product-upload-icon" data-path="{{ asset('assets/back-end/img/icons/product-upload-icon.svg') }}"></span>
    <span id="image-path-of-product-upload-icon-two" data-path="{{ asset('assets/back-end/img/400x400/img2.jpg') }}"></span>
...
@push('script')
    ...
    <script src="{{ asset('assets/back-end/js/vendor/product-add-update.js') }}"></script>
    ...
    <script>
        ...
        let thumbnail = '{{productImagePath('thumbnail').'/'.$product->thumbnail ?? asset('assets/back-end/img/400x400/img2.jpg') }}';
        $(function () {
            if (imageCount > 0) {
            ...
            $("#thumbnail").spartanMultiImagePicker({
                ...
                maxFileSize: '',
                placeholderImage: {
                    image: '{{ productImagePath('thumbnail').'/'. $product->thumbnail ?? asset('assets/back-end/img/400x400/img2.jpg') }}',
                    width: '100%',
                },
                dropFileLabel: "Drop Here",
                onAddRow: function (index, file) {
                    ...
                    let html = ` <div class='col-6 col-md-4 col-xl-4'>
                                    <div class="position-relative p-2 border-dashed-2 aspect-1">
                                        ...
                                        <div class="h-100 top-0 aspect-1 w-100 d-flex align-content-center justify-content-center overflow-hidden">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <img src="{{ asset('assets/back-end/img/icons/product-upload-icon.svg') }}" class="w-75">
                                                <h3 class="text-muted">{{ translate('Upload_Image') }}</h3>
                                            </div>
                                        </div>
                                    </label>
