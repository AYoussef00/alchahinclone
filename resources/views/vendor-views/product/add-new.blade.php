    ...
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('vendor.products.add') }}"
                        ...
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <textarea name="description[]"
                                          class="textarea form-control">{{ old('details') }}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                                        ...
                                        <div class="custom_upload_input position-relative border-dashed-2 aspect-1">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2 border-0">
                                                <img id="additional_Image_1" class="h-auto aspect-1 bg-white d-none "
                                                     src="{{ asset('assets/back-end/img/icons/product-upload-icon.svg-dummy') }}" alt="">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div
                                        ...
                                        <div class="custom_upload_input">
                                            ...
                                            <div class="img_area_with_preview position-absolute z-index-2">
                                                <img id="pre_meta_image_viewer" class="h-auto bg-white onerror-add-class-d-none" alt=""
                                                     src="{{ asset('assets/back-end/img/icons/product-upload-icon.svg-dummy') }}">
                                            </div>
                                            <div
                                                class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                <div
            ...
            <div class="row justify-content-end gap-3 mt-3 mx-1">
                ...
                <button type="submit" class="btn btn--primary px-5 product-add-requirements-check">{{ translate('submit') }}</button>
            </div>
        </form>
    </div>
...
@push('script')
    ...
    <script src="{{ asset('assets/back-end/js/vendor/product-add-colors-img.js') }}"></script>
@endpush
