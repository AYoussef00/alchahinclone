        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                <div class="left-content-card">
                    <img src="{{asset('/assets/back-end/img/cart.svg')}}" alt="{{translate('image')}}">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{asset('/assets/back-end/img/products.svg')}}" alt="{{translate('image')}}">
                    <div class="info">
                        <h4 class="subtitle">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                ...
                                <span class="trx-y-2 ml-2" data-toggle="tooltip" data-placement="top"
                                    ...
                                    <img src="{{asset('/assets/back-end/img/info-circle.svg')}}" alt="{{translate('image')}}">
                                </span>
                            </div>
                        </div>
                        <div class="text-center">
...
@push('script_2')
    ...
    <script src="{{ asset('assets/back-end/js/vendor/order-report.js') }}"></script>
@endpush
