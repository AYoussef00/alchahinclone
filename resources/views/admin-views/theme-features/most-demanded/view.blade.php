...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
            <img width="20" src="{{ asset('assets/back-end/img/most-demanded.png') }}" alt="">
                                ...
                                <div class="form-group">
                                    <div class="text-center mt-lg-3">
                                        <img class="border radius-10 ratio-4:1 max-w-655px w-100" id="viewer"
                                            src="{{ asset('assets/back-end/img/placeholder/placeholder-4-1.png') }}" alt="banner image"/>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('script')
    <script src="{{ asset('assets/back-end/js/banner.js') }}"></script>
@endpush
