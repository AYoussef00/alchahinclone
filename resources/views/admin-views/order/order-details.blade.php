...
@section('content')
                                ...
                                <div class="d-flex flex-wrap gap-10 justify-content-end">
                                    ...
                                    <a class="btn btn--primary px-4" target="_blank"
                                       href={{route('admin.orders.generate-invoice',[$order['id']])}}>
                                        <img src="{{ asset('assets/back-end/img/icons/uil_invoice.svg') }}"
                                             alt="" class="mr-1">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                <h4 class="d-flex gap-2">
                                    <img src="{{asset('/assets/back-end/img/product_setup.png')}}" alt=""
                                         width="20">
                ...
                @if(!$order->is_guest && $order->customer)
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                <h4 class="d-flex gap-2">
                                    <img src="{{asset('/assets/back-end/img/vendor-information.png')}}" alt="">
                    ...
                    <div class="card">
                        ...
                        @if($shippingAddress)
                            <div class="card-body">
                                <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                                    <h4 class="d-flex gap-2">
                                        <img src="{{asset('/assets/back-end/img/vendor-information.png')}}"
                                             alt="">
                            ...
                            @else
                                @if(!empty($order->seller->shop))
                                    ...
                                    <div class="media-body d-flex flex-column gap-2">
                                        ...
                                        <div class="d-flex align-items-start gap-2">
                                            <img src="{{asset('/assets/back-end/img/location.png')}}"
                                                 class="mt-1" alt="">
    ...
    <span id="location-icon" data-path="{{asset('assets/front-end/img/customer_location.png')}}"></span>
...
@push('script_2')
    <script
        ...
        defer></script>
    <script src="{{asset('assets/back-end/js/admin/order.js')}}"></script>
@endpush
