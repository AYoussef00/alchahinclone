                        ...
                        <div class="table-responsive">
                            ...
                            @else
                                <div class="text-center p-4">
                                    <img class="mb-3 w-160" src="{{asset('assets/back-end/svg/illustrations/sorry.svg')}}" alt="{{translate('image_description')}}">
...
@endsection
@push('script')
    <script src="{{asset('assets/back-end/js/admin/business-setting/offline-payment.js')}}"></script>
@endpush
