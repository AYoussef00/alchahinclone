                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-logo" alt=""
                                     src="{{ getValidImage(path: 'storage/company/'. $businessSetting['web_logo'] , type: 'backend-basic') }}">
                            </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-footer-logo"
                                     src="{{ getValidImage(path: 'storage/company/'. $businessSetting['footer_logo'] , type: 'backend-basic') }}"alt="">
                            </div>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-fav-icon"
                                     src="{{ getValidImage(path: 'storage/company/'. $businessSetting['fav_icon'] , type: 'backend-basic') }}" alt="">
                            </div>
                            <div class="position-relative mt-4">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-loader-icon"
                                     src="{{ getValidImage(path: 'storage/company/'. $businessSetting['loader_gif'] , type: 'backend-basic') }}" alt="">
                            </div>
                            <div class="position-relative mt-4">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-app-logo"
                                     src="{{ getValidImage(path: 'storage/company/'. $businessSetting['mob_logo'] , type: 'backend-basic') }}" alt="">
                            </div>
                            <div class="mt-4 position-relative">
...
@push('script')
    <script src="{{asset('assets/back-end/js/admin/business-setting/business-setting.js')}}"></script>
@endpush
