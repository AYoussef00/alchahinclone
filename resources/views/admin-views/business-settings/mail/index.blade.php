                        ...
                        <div class="nav nav-tabs border-0" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-link d-flex align-items-center gap-2" id="nav-profile-tab" data-toggle="tab"
                               href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">
                                <img width="22" src="{{asset('/assets/back-end/img/send-test-mail.png')}}"
                                     alt="">
                                ...
                                @if(isset($data_smtp))
                                    <div class="card-header">
                                        <h5 class="mb-0 d-flex align-items-center gap-2 text-capitalize">
                                            <img width="20" src="{{asset('/assets/back-end/img/smtp.png')}}"
                                                 alt="">
                    ...
                    <div class="swiper mySwiper pb-3">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3"
                                         src="{{asset('/assets/back-end/img/smtp-server.png')}}" loading="lazy"
                                         alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3"
                                         src="{{asset('/assets/back-end/img/config-smtp.png')}}" loading="lazy"
                                         alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2">
                                    <img width="80" class="mb-3"
                                         src="{{asset('/assets/back-end/img/test-smtp.png')}}" loading="lazy"
                                         alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="d-flex flex-column align-items-center gap-2 mb-4">
                                    <img width="80" class="mb-3"
                                         src="{{asset('/assets/back-end/img/enable-mail-config.png')}}"
                                         loading="lazy" alt="">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 text-center">
                    <div class="d-flex flex-column align-items-center gap-2">
                        <img width="80" class="mb-3" src="{{asset('/assets/back-end/img/send-mail.png')}}"
                             loading="lazy" alt="">
...
@push('script')
    ...
    <script src="{{asset('assets/back-end/js/admin/business-setting/mail.js')}}"></script>
@endpush
