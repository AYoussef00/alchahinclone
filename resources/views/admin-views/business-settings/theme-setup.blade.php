...
@section('content')
                                    ...
                                    <div class="d-flex gap-2 gap-sm-3 align-items-center">
                                        ...
                                        @if(theme_root_path() == $key)
                                            <button class="c1 bg-transparent p-0 border-0">
                                                <img src="{{asset('assets/back-end/img/icons/check.svg')}}" class="svg"
                                                     alt="">
                                            </button>
    ...
    <span id="get-notify-all-vendor-route-and-img-src"
          ...
          data-src = "{{asset('/assets/back-end/img/notify_success.png')}}"
...
@push('script')
    ...
    <script src="{{asset('assets/back-end/js/admin/business-setting/theme-setup.js')}}"></script>
@endpush
