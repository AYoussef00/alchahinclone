                                            ...
                                            <div class="custom_upload_input">
                                                ...
                                                <div class="position-absolute h-100 top-0 w-100 d-flex align-content-center justify-content-center">
                                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                                        <img src="{{asset('assets/back-end/img/icons/product-upload-icon.svg')}}" class="w-50" alt="">
...
@push('script')
    <script src="{{asset('assets/back-end/js/admin/business-setting/features-and-company-reliability-section.js')}}"></script>
@endpush
