...
<body class="footer-offset">
    ...
    <span id="onerror-chatting" data-onerror-chatting="{{asset('assets/back-end/img/image-place-holder.png')}}"></span>
    <span id="onerror-user" data-onerror-user="{{asset('assets/back-end/img/160x160/img1.jpg')}}"></span>
    <span id="get-root-path-for-toggle-modal-image" data-path="{{asset('/assets/back-end/img/modal')}}"></span>
