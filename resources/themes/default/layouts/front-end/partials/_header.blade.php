            ...
            <div class="container ">
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    <div class="navbar-tool dropdown d-none d-md-block {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}">
                        ...
                        <img src="{{ asset('assets/front-end/img/notification.png') }}" alt="Notification Icon" width="30" height="30">
                        </a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        @if ($businessMode == 'multi')
                            <li class="nav-item {{ request()->is('contact-us') ? 'active' : '' }}">
                                <a class="nav-link text-capitalize" href="{{ route('contact-us') }}">{{ translate('art_design') }}</a>
                            </li>
                        @endif
                        ...
                        @if ($businessMode == 'multi')
                            <li class="nav-item {{ request()->is('contact-us') ? 'active' : '' }}">
                                <a class="nav-link text-capitalize" href="{{ route('contact-us') }}">{{ translate('careers') }}</a>
                            </li>
                        @endif
                        ...
                        @if ($businessMode == 'multi')
                            <li class="nav-item {{ request()->is('contact-us') ? 'active' : '' }}">
                                <a class="nav-link text-capitalize" href="{{ route('contact-us') }}">{{ translate('contact_us') }}</a>
                            </li>
                        @endif
