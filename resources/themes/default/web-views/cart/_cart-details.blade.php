                    ...
                    @if ($free_delivery_status['status'] && (session()->missing('coupon_type') || session('coupon_type') !='free_delivery'))
                        <div class="free-delivery-area px-3 mb-3 mb-lg-2">
                            <div class="d-flex align-items-center gap-8">
                                <img class="__w-30px"
                                     src="{{ asset('assets/front-end/img/icons/free-shipping.png') }}" alt="">
                    ...
                    <div class="py-md-4">
                        <div class="text-center text-capitalize">
                            <img class="mb-3 mw-100"
                                 src="{{asset('/assets/front-end/img/icons/empty-cart.svg')}}" alt="">
...
@push('script')
    <script src="{{ asset('assets/front-end/js/cart-details.js') }}"></script>
@endpush
