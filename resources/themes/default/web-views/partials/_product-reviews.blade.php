            ...
            <div class="col-md-4 d-flex mb-3">
                <div class="media media-ie-fix me-4">
                    <img class="rounded-circle __img-64 object-cover"
                         src="{{ isset($productReview->user) ? getValidImage(path: 'storage/app/public/profile/'.$productReview->user->image, type: 'avatar') : asset('assets/front-end/img/image-place-holder.png') }}"
