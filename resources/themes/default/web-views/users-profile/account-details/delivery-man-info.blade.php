...
@push('css_or_js')
    <link rel="stylesheet" href="{{ asset('assets/front-end/css/deliveryman-info.css') }}">
@endpush
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex justify-content-end flex-wrap gap-3 gap-sm-3">
                                            <button type="button" class="btn btn-soft-info text-capitalize px-2 px-md-4"
                                                ...
                                                <img
                                                    src="{{asset('/assets/front-end/img/seller-info-chat.png')}}"
                                                    alt="">
                                                <span
                                    ...
                                    @foreach ($order->verificationImages as $image)
                                        @if(file_exists(base_path("storage/app/public/delivery-man/verification-image/".$image->image)))
                                            <img class="rounded" width="100"
                                                 src="{{asset('assets/front-end/img/cod.png')}}" alt="">
                                        @endif
                                    @endforeach
                                </div>
                            @endif
                            ...
                            <div class="border rounded bg-white p-2">
                                <div class="row g-2">
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="media gap-3">
                                            <img alt="{{ translate('deliveryman') }}" width="20"
                                                 src="{{ getValidImage(path: 'assets/front-end/img/icons/van.png', type: 'avatar') }}">
                                            <div class="media-body">
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="media gap-3">
                                            <img alt="{{ translate('deliveryman') }}" width="20"
                                                 src="{{ getValidImage(path:'assets/front-end/img/icons/track_order.png', type: 'product') }}">
                                            <div class="media-body">
