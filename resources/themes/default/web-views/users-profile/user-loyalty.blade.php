                        ...
                        <div class="d-flex justify-content-end mb-2 mb-sm-0 d-sm-none">
                            <div class="position-relative">
                                <button type="button"
                                    ...
                                    <img src="{{asset('assets/front-end/img/icons/icon-i.png')}}" alt=""
                                         width="18">
                                </button>
                                ...
                                <div class="bg--light my-1 p-3 p-sm-3 rounded d-flex justify-content-between g-2">
                                    <div class="">
                                        <h6 class="mb-2 d-flex align-items-center gap-8">
                                            @if($item['debit'] != 0)
                                                <img
                                                    src="{{ asset('assets/front-end/img/icons/coin-danger.png') }}"
                                                    width="25" alt="">
                                            @else
                                                <img
                                                    src="{{ asset('assets/front-end/img/icons/coin-success.png') }}"
                                                    width="25" alt="">
                                            @endif
...
@push('script')
    <script src="{{ asset('assets/front-end/js/user-loyalty.js') }}"></script>
@endpush
