...
@push('css_or_js')
    <link rel="stylesheet" href="{{asset('assets/front-end/vendor/nouislider/distribute/nouislider.min.css')}}"/>
    <link rel="stylesheet" href="{{ asset('assets/front-end/css/bootstrap-select.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/front-end/css/address.css') }}">
@endpush
                    ...
                    <div class="card card-body border-0">
                        <div class="d-flex justify-content-between align-items-center mb-3 gap-2">
                            ...
                            <button type="submit" class="btn btn--primary text-capitalize" data-toggle="modal"
                                ...
                                <img src="{{asset('/assets/front-end/img/add-address-icon.png')}}" class=""
                                     alt="">
                        ...
                        @if ($shippingAddresses->count() ==0)
                            <div class="text-center text-capitalize pb-5 pt-5">
                                <img class="mb-4" src="{{asset('assets/front-end/img/icons/address.svg')}}"
                                     alt="" width="70">
                                            ...
                                            <div class="d-flex justify-content-between gap-2 align-items-center">
                                                <a class="" title="Edit Address" id="edit"
                                                   href="{{route('address-edit',$shippingAddress->id)}}">
                                                    <img
                                                        src="{{asset('/assets/front-end/img/address-edit-icon.png')}}"
                                                        width="19" alt="">
                                                </a>
...
@push('script')
    ...
    <script src="{{ asset('assets/front-end/js/account-address.js') }}"></script>
