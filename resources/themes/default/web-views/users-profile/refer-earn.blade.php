                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center share-on-social">
                                        ...
                                        <a href="https://api.whatsapp.com/send?text={{$text}}.{{$link}}" target="_blank">
                                            <img alt=""
                                                 src="{{ getValidImage(path: 'assets/front-end/img/icons/whatsapp.png', type: 'product') }}">
                                        </a>
                                        <a href="mailto:recipient@example.com?subject=Referral%20Code%20Text&body={{$text}}%20Link:%20{{$link}}" target="_blank">
                                            <img alt=""
                                                 src="{{ getValidImage(path: 'assets/front-end/img/icons/gmail.png', type: 'product') }}">
                                        </a>
                                        <span class="click-to-copy-data-value" data-value="{{ route('home') }}?referral_code={{ $customer_detail->referral_code }}">
                                            <img alt=""
                                                 src="{{ getValidImage(path: 'assets/front-end/img/icons/share.png', type: 'product') }}">
                                        </span>
                                    </div>
                                </div>
