                    ...
                    <div class="col-sm-12">
                        <div class="text-center">
                            <img class="__img-125px object-cover" id="viewer"
                                 src="{{ getValidImage(path: 'assets/front-end/img/placeholder/user.png', type: 'avatar') }}" alt="banner image"/>
                        </div>
                        ...
                        <div class="pb-3">
                            <div class="text-center">
                                <img class="__img-125px object-cover" id="viewerLogo"
                                     src="{{ getValidImage(path: 'assets/front-end/img/placeholder/placeholder-1-1.png', type: 'logo') }}"
                                     alt="banner image"/>
                            </div>
                        </div>
                        ...
                        <div class="pb-3">
                            <div class="text-center">
                                <img class="height-100px" id="viewerBanner"
                                     src="{{ getValidImage(path: 'assets/front-end/img/placeholder/placeholder-4-1.png', type: 'wide-banner') }}"
                                     alt="banner image"/>
                            </div>
                        </div>
