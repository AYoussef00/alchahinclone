                        ...
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
                            <div class="details __h-100">
                                ...
                                <form id="add-to-cart-form" class="mb-2">
                                 ...
                                 @php
                                  $quotation  = \App\Models\Quotation::where("user_id",auth('customer')->user()->id)->where("product_id",$product->id)->first();
                                  @endphp
                                  
                                  @if(!$quotation)
                                           <a href="{{route('getProductQuotation',['id'=>$product->id])}}" class="btn btn-success element-center btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                                                <span class="string-limit">{{translate('get quotation')}}</span>
                                            </a>
                                            @else
                                             <span class="string-limit">{{translate('You has been sent a quotation alerdy')}}</span>
                                              @endif
                                    ...
                                    <div class="shipping-details-bottom-border">
                                        <div class="px-3 py-3">
                                            <img class="{{Session::get('direction') === "rtl" ? 'float-right ml-2' : 'mr-2'}} __img-20"
                                                 src="{{ getValidImage(path: 'storage/app/public/company-reliability/'.$value['image'], type: 'source', source: asset('/assets/front-end/img').'/'.$value['item'].'.png') }}"
                                                alt="">
                                        ...
                                        <div class="row d-flex justify-content-between">
                                            <div class="col-6 ">
                                                <div
                                                    ...
                                                    <div class="text-center">
                                                        <img src="{{asset('/assets/front-end/img/rating.svg')}}"
                                                             class="mb-2" alt="">
                                            ...
                                            <div class="col-6">
                                                <div
                                                    ...
                                                    <div class="text-center">
                                                        <img
                                                            src="{{asset('/assets/front-end/img/products.svg')}}"
                                                            class="mb-2" alt="">
                                                        <div class="__text-12px text-base">
                                        ...
                                        <div class="chat_with_seller-buttons">
                                            @if (auth('customer')->id())
                                                <button class="btn w-100 d-block text-center web--bg-primary text-white"
                                                    ...
                                                    <img class="mb-1" alt=""
                                                        src="{{asset('/assets/front-end/img/chat-16-filled-icon.png')}}">
                                            ...
                                            @else
                                                <a href="{{route('customer.auth.login')}}"
                                                   class="btn w-100 d-block text-center web--bg-primary text-white">
                                                    <img src="{{asset('/assets/front-end/img/chat-16-filled-icon.png')}}"
                                                        class="mb-1" alt="">
                                                    <span
                                        ...
                                        @if($product->added_by == 'admin' && ($inHouseTemporaryClose || ($inHouseVacationStatus && $currentDate >= $inHouseVacationStartDate && $currentDate <= $inHouseVacationEndDate)))
                                            <div class="{{Session::get('direction') === "rtl" ? 'right' : 'ml-3'}}">
                                                <span class="chat-seller-info" data-toggle="tooltip"
                                                    ...
                                                    <img src="{{asset('/assets/front-end/img/info.png')}}"
                                                         alt="i">
                                                </span>
                                            </div>
                                        @endif
                                    ...
                                    <div class="row d-flex justify-content-between">
                                        ...
                                        <div class="col-6">
                                            <div
                                                class="d-flex justify-content-center align-items-center rounded __h-79px">
                                                <div class="text-center">
                                                    <img src="{{asset('/assets/front-end/img/products.svg')}}"
                                                         class="mb-2" alt="">
                                                    <div class="__text-12px text-base">
                                                        <strong>{{$productsForReview->count()}}</strong> {{translate('products')}}
                                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5">
                    <div class="text-center">
                        <img src="{{asset('/assets/front-end/img/icons/remove-wishlist.png')}}" alt="{{ translate('wishlist') }}">
...
@push('script')
    <script src="{{ asset('assets/front-end/js/product-details.js') }}"></script>
