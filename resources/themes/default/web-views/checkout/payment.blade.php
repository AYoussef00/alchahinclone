...
@push('css_or_js')
    <link rel="stylesheet" href="{{ asset('assets/front-end/css/payment.css') }}">
                                                ...
                                                <form action="{{route('checkout-complete')}}" method="get" class="needs-validation" id="cash_on_delivery_form">
                                                    <label class="m-0">
                                                        ...
                                                        <span class="btn btn-block click-if-alone d-flex gap-2 align-items-center cursor-pointer">
                                                            ...
                                                            <img width="20" src="{{ asset('assets/front-end/img/icons/money.png') }}" alt="">
                                            ...
                                            <div>
                                                <div class="card cursor-pointer">
                                                    <button class="btn btn-block click-if-alone d-flex gap-2 align-items-center" type="submit"
                                                        ...
                                                        <img width="20" src="{{ asset('assets/front-end/img/icons/wallet-sm.png') }}" alt=""/>
...
@push('script')
    <script src="{{ asset('assets/front-end/js/payment.js') }}"></script>
@endpush
